...
function Elements6() {
  return (
    <div className="relative size-full" data-name="elements">
      <div className="absolute inset-[-4.73%_-4.74%_-4.74%_-4.74%]">
...
function Elements7() {
  return (
    <div className="relative size-full" data-name="elements">
      <div className="absolute inset-[-5.01%_-5.01%_-4.99%_-5%]">
...
export default function SidebarAdmin() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative rounded-[16px] size-full" data-name="Sidebar - Admin">
