  ...
  const sidebarGroups = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "pagamento", label: "Formas de pagamento", icon: ["M22 10H2M14.5 14.5H17.5", "M5.75 5H18.25C20.3211 5 22 6.67893 22 8.75V16.25C22 18.3211 20.3211 20 18.25 20H5.75C3.67893 20 2 18.3211 2 16.25V8.75C2 6.67893 3.67893 5 5.75 5Z"] },
                ...
                <section className="rounded-xl border border-[#e9eaeb] bg-white shadow-sm">
                  ...
                  <div className="flex flex-col gap-4 px-4 pb-4 pt-3">
                    ...
                    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                      <div className="flex flex-col gap-[6px]">
                        <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[14px] text-[#181d27]">O que está incluso</p>
                        <textarea className={textAreaClass} value={incluso} onChange={(e) => setIncluso(e.target.value)} placeholder="Ingressos, condutor, seguro, equipamentos" />
                      </div>
                      <div className="flex flex-col gap-[6px]">
                        <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[14px] text-[#181d27]">O que não está incluso</p>
                        <textarea className={textAreaClass} value={naoIncluso} onChange={(e) => setNaoIncluso(e.target.value)} placeholder="Alimentação, transporte, despesas extras" />
                      </div>
                    </div>
                    <div className="flex flex-col gap-[6px]">
                            ...
                            {tarifas.map((tarifa, idx) => {
                              ...
                              return (
                                <div key={idx} className="flex items-center gap-3 rounded-lg border border-border bg-muted/40 p-3 transition-[opacity,background-color,border-color]">
                                  ...
                                  <div className="flex shrink-0 items-center gap-2.5">
                                    <button type="button" onClick={() => { setTarifaDraft({ ...tarifas[idx] }); setTarifaDrawerIdx(idx); }} className="flex size-8 cursor-pointer items-center justify-center rounded-md border border-border text-primary transition-colors hover:bg-primary/10">
                                      <svg className="size-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"><path d="M16.4249 4.60509L17.4149 3.6151C18.2351 2.79497 19.5648 2.79497 20.3849 3.6151C21.205 4.43524 21.205 5.76493 20.3849 6.58507L19.3949 7.57506M16.4249 4.60509L9.76558 11.2644C9.25807 11.772 8.89804 12.4078 8.72397 13.1041L8 16L10.8959 15.276C11.5922 15.102 12.228 14.7419 12.7356 14.2344L19.3949 7.57506M16.4249 4.60509L19.3949 7.57506" /><path d="M18.9999 13.5C18.9999 16.7875 18.9999 18.4312 18.092 19.5376C17.9258 19.7401 17.7401 19.9258 17.5375 20.092C16.4312 21 14.7874 21 11.4999 21H11C7.22876 21 5.34316 21 4.17159 19.8284C3.00003 18.6569 3 16.7712 3 13V12.5C3 9.21252 3 7.56879 3.90794 6.46244C4.07417 6.2599 4.2599 6.07417 4.46244 5.90794C5.56879 5 7.21252 5 10.5 5" strokeLinecap="round" /></svg>
                                    </button>
                                    {tarifas.length > 1 && (
                              ...
                              {lotes.map((lote, idx) => {
                                ...
                                return (
                                  <div key={idx} className="flex items-center gap-3 rounded-lg border border-border bg-muted/40 p-3 transition-[opacity,background-color,border-color]">
                                    ...
                                    <div className="flex shrink-0 items-center gap-2.5">
                                      <button type="button" onClick={() => { setLoteDraft({ ...lotes[idx] }); setLoteDrawerIdx(idx); }} className="flex size-8 cursor-pointer items-center justify-center rounded-md border border-border text-primary transition-colors hover:bg-primary/10">
                                        <svg className="size-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"><path d="M16.4249 4.60509L17.4149 3.6151C18.2351 2.79497 19.5648 2.79497 20.3849 3.6151C21.205 4.43524 21.205 5.76493 20.3849 6.58507L19.3949 7.57506M16.4249 4.60509L9.76558 11.2644C9.25807 11.772 8.89804 12.4078 8.72397 13.1041L8 16L10.8959 15.276C11.5922 15.102 12.228 14.7419 12.7356 14.2344L19.3949 7.57506M16.4249 4.60509L19.3949 7.57506" /><path d="M18.9999 13.5C18.9999 16.7875 18.9999 18.4312 18.092 19.5376C17.9258 19.7401 17.7401 19.9258 17.5375 20.092C16.4312 21 14.7874 21 11.4999 21H11C7.22876 21 5.34316 21 4.17159 19.8284C3.00003 18.6569 3 16.7712 3 13V12.5C3 9.21252 3 7.56879 3.90794 6.46244C4.07417 6.2599 4.2599 6.07417 4.46244 5.90794C5.56879 5 7.21252 5 10.5 5" strokeLinecap="round" /></svg>
                                      </button>
                                      {lotes.length > 1 && (
                  ...
                  <div className="flex flex-col gap-[6px]">
                    ...
                    <div className="grid grid-cols-2 gap-[8px]">
                      {([
                        ...
                        { id: "Pix", icon: <svg className="size-[20px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M7.38 7.53L11.07 3.84a1.31 1.31 0 011.86 0l3.69 3.69M7.38 16.47l3.69 3.69a1.31 1.31 0 001.86 0l3.69-3.69M21 9.87l-3.69 3.69a1.31 1.31 0 01-1.86 0L12 10.11 8.55 13.56a1.31 1.31 0 01-1.86 0L3 9.87M3 14.13l3.69-3.69a1.31 1.31 0 011.86 0L12 13.89l3.45-3.45a1.31 1.31 0 011.86 0L21 14.13" /></svg>, subtitle: "Pagamento instantâneo" },
                        { id: "Boleto", icon: <svg className="size-[20px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M2 4v16M6 4v16M10 4v16M14 4v16M18 4v16M22 4v16M8 4v16M12 4v16M16 4v16M20 4v16M4 4v16" /></svg>, subtitle: "Compensação em até 3 dias" },
                        { id: "Dinheiro", icon: <svg className="size-[20px]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M2 8.5h14M2 15.5h14M6 12a3 3 0 103 3 3 3 0 00-3-3z" /><rect x="2" y="5" width="14" height="14" rx="2" /><path d="M18 7h2a2 2 0 012 2v6a2 2 0 01-2 2h-2" /></svg>, subtitle: "Pagamento presencial" },
                      ] as const).map((forma) => {
