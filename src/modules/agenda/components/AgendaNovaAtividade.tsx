...
function maskDate(raw: string): string {
  ...
  for (let i = 0; i < digits.length && valid.length < 8; i++) {
    ...
    if (pos === 0) { if (d > 3) continue; }
    else if (pos === 1) { const f = parseInt(valid[0]!, 10); if (f === 3 && d > 1) continue; if (f === 0 && d === 0) continue; }
    else if (pos === 2) { if (d > 1) continue; }
    else if (pos === 3) { const f = parseInt(valid[2]!, 10); if (f === 1 && d > 2) continue; if (f === 0 && d === 0) continue; }
    valid += digits[i];
  }
    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[520px] rounded-[16px] bg-white shadow-[0px_8px_24px_0px_rgba(0,0,0,0.15)]">
        <div className="shrink-0">
          <div className="flex items-start justify-between px-[24px] pb-[16px] pt-[20px]">
            <div className="flex flex-col gap-[4px]">
              <p className="font-['Helvetica_Neue:Medium',sans-serif] leading-[normal] text-[16px] text-[#181d27]">Enviar solicitação de atribuição</p>
              <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[14px] leading-[20px] text-[#535862]">
                <span className="font-['Helvetica_Neue:Medium',sans-serif] text-[#252b37]">{guide}</span> já está alocado em outra atividade no mesmo horário.
              </p>
            </div>
            <button onClick={onCancel} className="flex size-[32px] shrink-0 cursor-pointer items-center justify-center rounded-[6px] transition-colors hover:bg-[#f5f5f5]">
        ...
        <div className="flex flex-col gap-[12px] px-[24px] py-[20px]">
          <div className="flex items-center gap-[12px] rounded-[10px] border border-[#f5f5f5] bg-[#fafafa] px-[12px] py-[10px]">
            <div className="flex size-[32px] shrink-0 items-center justify-center rounded-full border border-[#bfdbfe] bg-[#eff6ff]">
              <p className="font-['Helvetica_Neue:Medium',sans-serif] text-[11px] text-[#0b5ed7]">{getInitials(guide)}</p>
            </div>
            <div className="min-w-0 flex-1">
              <p className="truncate font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#252b37]">{guide}</p>
              <p className="truncate font-['Helvetica_Neue:Regular',sans-serif] text-[11px] text-[#e17c00]">Alocado em: {conflictActivity}</p>
            </div>
          </div>
          <div className="flex items-center gap-[10px] rounded-[10px] border border-[#f5f5f5] bg-[#f8f9fc] px-[12px] py-[8px]">
            ...
            <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[12px] leading-[16px] text-[#414651]">
              Caso prossiga, a notificação chegará para esse membro como convite. Ele poderá aceitar ou recusar a atribuição dessa atividade.
            </p>
          </div>
        </div>
        <div className="flex gap-[12px] px-[24px] pb-[24px] pt-[4px]">
          <button onClick={onCancel} className="h-[40px] flex-1 cursor-pointer rounded-[8px] border border-[#e9eaeb] bg-white font-['Helvetica_Neue:Regular',sans-serif] text-[14px] text-[#414651] transition-colors hover:bg-[#f8fafc]">Cancelar</button>
          <button onClick={onConfirm} className="h-[40px] flex-1 cursor-pointer rounded-[8px] bg-[#0b5ed7] font-['Helvetica_Neue:Medium',sans-serif] text-[14px] text-white transition-colors hover:bg-[#084fb7]">Enviar solicitação</button>
        </div>
      </div>
    </div>,
    document.body
...
function GuideRemoveConfirmModal({
  ...
  const description = all
    ...
    : <>Tem certeza que deseja remover <span className="font-['Helvetica_Neue:Medium',sans-serif] text-[#252b37]">{guide}</span> da equipe responsável por esta atividade?</>;
    ...
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-[520px] rounded-[16px] bg-white shadow-[0px_8px_24px_0px_rgba(0,0,0,0.15)]">
        <div className="shrink-0">
          <div className="flex items-start justify-between px-[24px] pb-[16px] pt-[20px]">
            <div className="flex flex-col gap-[4px]">
              <p className="font-['Helvetica_Neue:Medium',sans-serif] leading-[normal] text-[16px] text-[#181d27]">{title}</p>
              <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[14px] leading-[normal] text-[#535862]">{description}</p>
            </div>
            <button onClick={onCancel} className="flex size-[32px] shrink-0 cursor-pointer items-center justify-center rounded-[6px] transition-colors hover:bg-[#f5f5f5]">
              <svg className="size-[16px]" fill="none" viewBox="0 0 16 16"><path d="M4 4l8 8M12 4l-8 8" stroke="#717680" strokeWidth="1.5" strokeLinecap="round"/></svg>
            </button>
        ...
        <div className="flex flex-col gap-[12px] px-[24px] py-[20px]">
          {!all && guide && (
            <div className="flex items-center gap-[12px] rounded-[10px] border border-[#f5f5f5] bg-[#fafafa] px-[12px] py-[10px]">
              ...
              <div className="min-w-0 flex-1">
                <p className="truncate font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#252b37]">{guide}</p>
                <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[11px] text-[#dc6803]">Sem seguro</p>
              </div>
            </div>
          )}
          <div className="flex items-center gap-[10px] rounded-[10px] border border-[#f5f5f5] bg-[#f8f9fc] px-[12px] py-[8px]">
        ...
        <div className="flex gap-[12px] px-[24px] pb-[24px] pt-[4px]">
          <button onClick={onCancel} className="h-[40px] flex-1 cursor-pointer rounded-[8px] border border-[#e9eaeb] bg-white font-['Helvetica_Neue:Regular',sans-serif] text-[14px] text-[#414651] transition-colors hover:bg-[#f8fafc]">Cancelar</button>
          <button onClick={onConfirm} className="h-[40px] flex-1 cursor-pointer rounded-[8px] bg-[#d92d20] font-['Helvetica_Neue:Medium',sans-serif] text-[14px] text-white transition-colors hover:bg-[#b42318]">{all ? "Remover equipe" : "Remover membro"}</button>
        </div>
      </div>
    </div>,
    document.body
...
export function AgendaNovaAtividade({ onBack }: AgendaNovaAtividadeProps) {
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      if (produtoRef.current && !produtoRef.current.contains(e.target as Node)) setProdutoOpen(false);
    };
    document.addEventListener("mousedown", handleClick);
    return () => document.removeEventListener("mousedown", handleClick);
  }, [produtoOpen]);
  ...
  const [saidas, setSaidas] = useState([{ id: 1, horarioInicio: "", horarioTermino: "", capacidadeMin: 0, capacidadeMax: 0, equipe: [] as string[] }]);
  const [draggedSaidaId, setDraggedSaidaId] = useState<number | null>(null);
  const draggedSaidaIdRef = useRef<number | null>(null);
  const addSaida = () => setSaidas((prev) => [...prev, { id: (prev[prev.length - 1]?.id ?? 0) + 1, horarioInicio: "", horarioTermino: "", capacidadeMin: 0, capacidadeMax: 0, equipe: [] }]);
  ...
  const updateSaida = (id: number, patch: Partial<typeof saidas[0]>) => setSaidas((prev) => prev.map((s) => s.id === id ? { ...s, ...patch } : s));
  const removeSaida = (id: number) => setSaidas((prev) => prev.length > 1 ? prev.filter((s) => s.id !== id) : prev);
  ...
  const [removeGuideConfirm, setRemoveGuideConfirm] = useState<{ guide?: string; all?: boolean } | null>(null);
  ...
  const addTeamGuide = (guide: string) => {
    setForm((prev) => prev.equipe.includes(guide) ? prev : { ...prev, equipe: [...prev.equipe, guide] });
    setTeamDropdownOpen(false);
    setTeamSearch("");
  };
    ...
    <div className="fixed inset-0 z-50 bg-[#f8fafc] flex flex-col">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1fr_400px]">
              ...
              <div className="grid grid-cols-1 gap-4 pt-2 sm:grid-cols-2">
                <FieldRow label="Local da atividade">
                  <div className="relative" ref={localRef}>
                    <div className={cn("flex items-center gap-[8px] w-full h-9 rounded-md px-3 transition-colors border border-border hover:border-[#d0d5dd]", fieldSurfaceClass)}>
                      ...
                      <input
                        type="text"
                        className="flex-1 font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#252b37] bg-transparent outline-none placeholder:text-muted-foreground min-w-0"
                        placeholder={form.local ? localOptions.find((o) => o.value === form.local)?.label : "Selecione o local"}
                        value={localSearch}
                        onChange={(e) => { setLocalSearch(e.target.value); if (!localOpen) setLocalOpen(true); }}
                        onFocus={() => setLocalOpen(true)}
                      />
                      <button type="button" onClick={() => setLocalOpen(!localOpen)} className="cursor-pointer shrink-0">
                        <svg className={`size-[14px] text-[#a4a7ae] transition-transform ${localOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                      </button>
                    </div>
                    {localOpen && (() => {
                      const filtered = localOptions.filter((o) => o.label.toLowerCase().includes(localSearch.toLowerCase()));
                      return (
                          ...
                          <div className="max-h-[200px] overflow-y-auto py-[4px]">
                            {filtered.length > 0 ? filtered.map((opt) => (
                              <button
                                key={opt.value}
                                type="button"
                                onClick={() => { update("local", form.local === opt.value ? "" : opt.value); setLocalOpen(false); setLocalSearch(""); }}
                                className={cn("flex w-full items-center px-[12px] py-[8px] hover:bg-[#f8fafc] transition-colors cursor-pointer font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-left", form.local === opt.value ? "text-[#0b5ed7] bg-[#f0f5ff]" : "text-[#252b37]")}
                              >
                                {opt.label}
                              </button>
                            )) : (
                              <p className="px-[12px] py-[8px] font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#717680]">Nenhum local encontrado.</p>
                            )}
                          </div>
                        </div>
                      );
                ...
                >
                  <div className="relative" ref={produtoRef}>
                    <div className={cn("flex items-center gap-[8px] w-full h-9 rounded-md px-3 transition-colors border border-border hover:border-[#d0d5dd]", fieldSurfaceClass)}>
                      ...
                      <input
                        type="text"
                        className={cn("flex-1 font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#252b37] bg-transparent outline-none placeholder:text-muted-foreground min-w-0", fieldSurfaceClass)}
                        placeholder={form.produto ? produtoOptions.find((o) => o.value === form.produto)?.label : "Selecione um produto"}
                        value={produtoSearch}
                        onChange={(e) => { setProdutoSearch(e.target.value); if (!produtoOpen) setProdutoOpen(true); }}
                        onFocus={() => setProdutoOpen(true)}
                      />
                      <button type="button" onClick={() => setProdutoOpen(!produtoOpen)} className="cursor-pointer shrink-0">
                        <svg className={`size-[14px] text-[#a4a7ae] transition-transform ${produtoOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                      </button>
                    </div>
                    {produtoOpen && (() => {
                      const filtered = produtoOptions.filter((o) => o.label.toLowerCase().includes(produtoSearch.toLowerCase()));
                      return (
                        <div className="absolute top-full left-0 right-0 mt-[4px] bg-white border border-[#e9eaeb] rounded-[8px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.12)] z-50 overflow-hidden">
                          <div className="max-h-[200px] overflow-y-auto py-[4px]">
                            {filtered.length > 0 ? filtered.map((opt) => (
                              <button
                                ...
                                className={cn(
                                  "flex w-full items-center gap-[10px] px-[12px] py-[8px] hover:bg-[#f8fafc] transition-colors cursor-pointer font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-left",
                                  form.produto === opt.value ? "text-[#0b5ed7] bg-[#f0f5ff]" : "text-[#252b37]"
                                )}
                              >
                                {opt.label}
                              </button>
                            )) : (
                              <p className="px-[12px] py-[8px] font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#717680]">Nenhum produto encontrado.</p>
                            )}
                          </div>
                        </div>
                      );
                  ...
                  <div className="flex flex-col gap-3">
                    {saidas.map((saida, idx) => (
                      <div
                        ...
                        onDrop={(e) => {
                          e.preventDefault();
                          const draggedId = Number(e.dataTransfer.getData("text/plain")) || draggedSaidaIdRef.current;
                          if (draggedId !== null) moveSaida(draggedId, saida.id);
                          draggedSaidaIdRef.current = null;
                          setDraggedSaidaId(null);
                        }}
                        className={cn(
                          "flex items-center gap-3 rounded-lg border border-border bg-muted/40 p-3 transition-[opacity,background-color,border-color]",
                          draggedSaidaId === saida.id && "border-primary/40 bg-primary/5 opacity-60"
                        )}
                      >
                        <button
                          type="button"
                          ...
                          className={cn("flex size-[20px] shrink-0 items-center justify-center transition-colors", saidas.length > 1 ? "text-muted-foreground cursor-grab active:cursor-grabbing" : "text-muted-foreground/30")}
                        ...
                        <div className="flex min-w-0 flex-1 flex-col gap-0.5">
                          ...
                          <span className="text-muted-foreground text-xs">
                            {[
                              saida.horarioInicio && saida.horarioTermino ? `${saida.horarioInicio} – ${saida.horarioTermino}` : "Sem horários definidos",
                              saida.equipe.length > 0 ? `${saida.equipe.length} membro(s)` : "sem equipe atribuída",
                              saida.capacidadeMax > 0 ? `${saida.capacidadeMin}–${saida.capacidadeMax} vagas` : "sem capacidade atribuída",
                            ].join(", ")}
                          </span>
                        </div>
                        <div className="flex shrink-0 items-center gap-2.5">
                          <TooltipProvider>
                            <Tooltip>
                              <TooltipTrigger asChild>
                                <button type="button" onClick={() => setEditingSaidaId(saida.id)} className="flex size-8 items-center justify-center rounded-md border border-border text-primary transition-colors hover:bg-primary/10">
                          ...
                          {saidas.length > 1 && (
                            <TooltipProvider>
                              <Tooltip>
                                <TooltipTrigger asChild>
                                  <button type="button" onClick={() => removeSaida(saida.id)} className="flex size-8 items-center justify-center rounded-md border border-border text-destructive transition-colors hover:bg-destructive/10">
                    ...
                    <button
                      type="button"
                      onClick={addSaida}
                      className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-border py-2.5 text-sm font-medium text-primary transition-colors hover:bg-muted/50"
                    >
            ...
            <CardContent className="flex flex-col gap-4">
              {form.multiplosHorarios ? (
                <div className="flex items-center gap-[10px] bg-[#f8f9fc] border border-[#f5f5f5] rounded-[10px] px-[12px] py-[8px]">
                  ...
                  <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[12px] text-[#414651] leading-[14px]">Cada horário tem suas próprias vagas. Defina a capacidade em cada saída.</p>
                </div>
              ) : (
                <div className="grid grid-cols-2 gap-4">
                  <FieldRow label="Capacidade mínima">
                    <Input
                      ...
                      onFocus={(e) => { if (form.capacidadeMin === 0) e.target.select(); }}
                    />
                  </FieldRow>
                  <FieldRow label="Capacidade máxima">
                    <Input
                      className={cn(fieldSurfaceClass, form.capacidadeMax > 0 && form.capacidadeMin > 0 && form.capacidadeMax < form.capacidadeMin && "border-[#d92d20] focus-visible:border-[#d92d20] focus-visible:ring-[#d92d20]/20")}
                      inputMode="numeric"
                      ...
                      onFocus={(e) => { if (form.capacidadeMax === 0) e.target.select(); }}
                    />
                    {form.capacidadeMax > 0 && form.capacidadeMin > 0 && form.capacidadeMax < form.capacidadeMin && (
                      <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[11px] text-[#d92d20] leading-[14px]">A capacidade máxima deve ser maior ou igual à mínima.</p>
                    )}
                  </FieldRow>
                </div>
              )}
              <div className="flex items-center justify-between gap-4">
                <div className="flex flex-col gap-0.5">
                  ...
                  <span className="text-muted-foreground text-xs">
                    Aceite reservas além da capacidade máxima para cobrir desistências de última hora.
                  </span>
                </div>
                <Switch
        ...
        <div className="flex flex-col gap-6">
          ...
          <Card size="sm" className={cardOverride}>
            ...
            <CardContent>
              ...
              {form.visibilidade === "interna" && (
                <p className="text-muted-foreground text-xs mt-2">Atividades internas não aparecem na loja, sendo acessíveis somente por link direto.</p>
              )}
            </CardContent>
          </Card>
            ...
            <CardContent>
              <div className="flex flex-col gap-[12px]">
                <div className="relative" ref={grupoRef}>
                  <div className={cn("flex items-center gap-[8px] w-full h-9 rounded-md px-3 transition-colors border border-border hover:border-[#d0d5dd]", fieldSurfaceClass)}>
                    ...
                    <input
                      type="text"
                      className="flex-1 font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#252b37] bg-transparent outline-none placeholder:text-muted-foreground min-w-0"
                      placeholder={form.grupoClientes.length > 0 ? "Buscar ou adicionar grupos" : "Selecione um ou mais grupos"}
                      value={grupoSearch}
                      onChange={(e) => { setGrupoSearch(e.target.value); if (!grupoOpen) setGrupoOpen(true); }}
                      onFocus={() => setGrupoOpen(true)}
                    />
                    <button type="button" onClick={() => setGrupoOpen(!grupoOpen)} className="cursor-pointer shrink-0">
                      <svg className={`size-[14px] text-[#a4a7ae] transition-transform ${grupoOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
                    </button>
                  </div>
                  {grupoOpen && (() => {
                    const trimmedSearch = grupoSearch.trim();
                    const filtered = availableGrupoOptions.filter((o) => o.label.toLowerCase().includes(trimmedSearch.toLowerCase()));
                    return (
                      <div className="absolute top-full left-0 right-0 mt-[4px] bg-white border border-[#e9eaeb] rounded-[8px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.12)] z-50 overflow-hidden">
                        <div className="max-h-[200px] overflow-y-auto py-[4px]">
                          {filtered.length > 0 ? filtered.map((opt) => (
                              ...
                              onClick={() => {
                                update(
                                  ...
                                  form.grupoClientes.includes(opt.value)
                                    ? form.grupoClientes.filter((value) => value !== opt.value)
                                    : [...form.grupoClientes, opt.value]
                                );
                                setGrupoSearch("");
                              }}
                              className={cn("flex w-full items-center justify-between px-[12px] py-[8px] hover:bg-[#f8fafc] transition-colors cursor-pointer font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-left", form.grupoClientes.includes(opt.value) ? "text-[#0b5ed7] bg-[#f0f5ff]" : "text-[#252b37]")}
                            >
                              <span>{opt.label}</span>
                              {form.grupoClientes.includes(opt.value) && (
                            ...
                            <div className="py-[4px]">
                              <p className="px-[12px] py-[8px] font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#717680]">Nenhum grupo encontrado</p>
                              {trimmedSearch && (
                                <button
                                  type="button"
                                  onClick={() => {
                                    const value = `custom-${trimmedSearch.toLowerCase().normalize("NFD").replace(/[\u0300-\u036f]/g, "").replace(/[^a-z0-9]+/g, "-").replace(/^-|-$/g, "")}`;
                                    const option = { value, label: trimmedSearch };
                                    setCustomGrupoOptions((prev) => prev.some((item) => item.value === value) ? prev : [...prev, option]);
                                    update("grupoClientes", form.grupoClientes.includes(value) ? form.grupoClientes : [...form.grupoClientes, value]);
                                    setGrupoSearch("");
                                    setGrupoOpen(false);
                                  }}
                ...
                {form.grupoClientes.length > 0 && (() => {
                  const selectedGroups = availableGrupoOptions.filter((option) => form.grupoClientes.includes(option.value));
                  return (
                    <div className="flex flex-wrap gap-[6px]">
                      {selectedGroups.map((selected) => (
                        <span key={selected.value} className="inline-flex items-center gap-[6px] rounded-full border border-[#dbeafe] bg-[#e8f0fe] px-[10px] py-[4px] font-['Helvetica_Neue:Regular',sans-serif] text-[12px] text-[#0b5ed7]">
                          {selected.label}
                          <button type="button" onClick={() => update("grupoClientes", form.grupoClientes.filter((value) => value !== selected.value))} className="cursor-pointer transition-colors hover:text-[#084fb7]" aria-label={`Remover ${selected.label}`}>
          ...
          {/* Equipe */}
          <Card size="sm" className={cn(cardOverride, "!overflow-visible", form.multiplosHorarios && "gap-4 data-[size=sm]:gap-4", !form.multiplosHorarios && "flex-1", form.equipe.length > 0 && !form.multiplosHorarios && "!pb-0")}>
            ...
            {form.multiplosHorarios && (
              <div className="flex items-center gap-[10px] bg-[#f8f9fc] border border-[#f5f5f5] rounded-[10px] px-[12px] py-[8px] mx-4 -mt-2 mb-1">
                <svg className="size-[24px] shrink-0" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="11" fill="#4A7BF7" opacity="0.15"/><circle cx="12" cy="12" r="8" fill="#4A7BF7"/><path d="M12 16v-4M12 8h.01" stroke="white" strokeWidth="2" strokeLinecap="round"/></svg>
                <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[12px] text-[#414651] leading-[14px]">Com múltiplos horários habilitados, a equipe escalada é definida em cada saída.</p>
              </div>
            )}
            {!form.multiplosHorarios && (<>
                        ...
                        <div className="relative shrink-0" ref={memberMenu === i ? memberMenuRef : undefined}>
                          ...
                          {memberMenu === i && (
                            <div className="absolute right-0 top-full mt-[4px] bg-white border border-[#f5f5f5] rounded-[8px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.12)] w-[200px] z-10 py-[4px]">
                              ...
                              <button type="button" onClick={() => { setRemoveGuideConfirm({ guide: g }); setMemberMenu(null); }} className="cursor-pointer flex items-center gap-[8px] w-full px-[12px] py-[8px] hover:bg-[#fef3f2] transition-colors">
      ...
      <div className="flex justify-end pt-[16px] pb-[8px]">
        <button
          ...
          className={cn(
            "font-['Helvetica_Neue:Medium',sans-serif] text-[13px] rounded-[8px] px-[16px] py-[8px] transition-colors",
            form.titulo.trim()
              ? "bg-[#0b5ed7] hover:bg-[#084fb7] text-white cursor-pointer"
        ...
        <GuideRemoveConfirmModal
          ...
          onConfirm={() => {
            if (removeGuideConfirm.all) {
              ...
              setForm((prev) => ({ ...prev, equipe: prev.equipe.filter((item) => item !== guide) }));
...
function RecurrencePanel({ form, update }: { form: FormState; update: <K extends keyof FormState>(key: K, value: FormState[K]) => void }) {
  ...
  const removeCustomDate = (date: string) => {
    update("recorrenciaDatasPersonalizadas", form.recorrenciaDatasPersonalizadas.filter((d) => d !== date));
  };

  const toggleWeekday = (day: number) => {
    const current = form.recorrenciaDiasSemana;
    update("recorrenciaDiasSemana", current.includes(day) ? current.filter((d) => d !== day) : [...current, day].sort());
  };

  // Summary text
  const summary = (() => {
    if (tipo === "diario") {
      return form.recorrenciaIntervalo === 1 ? "Repete todos os dias" : `Repete a cada ${form.recorrenciaIntervalo} dias`;
    }
    if (tipo === "semanal") {
    ...
    if (tipo === "mensal") {
      if (form.recorrenciaMensalModo === "dia") return `Repete todo dia ${form.recorrenciaMensalDia} do mês`;
  ...
  return (
    <div className="rounded-[10px] border border-[#f5f5f5] bg-[#fafafa] p-[16px] space-y-[16px]">
      ...
      <div className="flex items-center gap-[8px]">
        <svg className="size-[20px] text-[#414651]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M16.3884 3L17.3913 3.97574C17.8393 4.41165 18.0633 4.62961 17.9844 4.81481C17.9056 5 17.5888 5 16.9552 5H9.19422C5.22096 5 2 8.13401 2 12C2 13.4872 2.47668 14.8662 3.2895 16"/><path d="M7.61156 21L6.60875 20.0243C6.16074 19.5883 5.93673 19.3704 6.01557 19.1852C6.09441 19 6.4112 19 7.04478 19H14.8058C18.779 19 22 15.866 22 12C22 10.5128 21.5233 9.13383 20.7105 8"/></svg>
        <p className="font-['Helvetica_Neue:Medium',sans-serif] text-[13px] text-[#252b37] uppercase tracking-[0.5px]">Recorrência</p>
        <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#0b5ed7]">{summary}</p>
      </div>
      ...
      <div className="flex gap-[4px] bg-white rounded-[8px] border border-[#e9eaeb] p-[4px]">
        {(["diario", "semanal", "mensal", "personalizado"] as const).map((opt) => (
          <button
            ...
            className={cn(
              "flex-1 rounded-[6px] px-[12px] py-[6px] text-[13px] transition-all cursor-pointer",
              tipo === opt
                ? "font-['Helvetica_Neue:Medium',sans-serif] bg-[#0b5ed7] text-white shadow-sm"
                : "font-['Helvetica_Neue:Regular',sans-serif] text-[#535862] hover:text-[#252b37] hover:bg-[#f8fafc]"
            )}
          >
            {opt === "diario" ? "Diário" : opt === "semanal" ? "Semanal" : opt === "mensal" ? "Mensal" : "Personalizado"}
          </button>
        ))}
      </div>
      ...
      {tipo === "diario" && (
        <div className="flex items-center gap-[8px]">
          ...
          <Input
            className="w-[56px] text-center bg-white"
            inputMode="numeric"
          ...
          />
          <span className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#414651]">dia(s).</span>
        </div>
      )}
        ...
        <div className="flex gap-[6px]">
          {WEEKDAYS.map((label, i) => (
            <button
              ...
              className={cn(
                "flex size-[36px] items-center justify-center rounded-[8px] border text-[13px] transition-all cursor-pointer",
                form.recorrenciaDiasSemana.includes(i)
                  ? "font-['Helvetica_Neue:Medium',sans-serif] border-[#0b5ed7] bg-[#f0f5ff] text-[#0b5ed7]"
                  : "font-['Helvetica_Neue:Regular',sans-serif] border-[#e9eaeb] bg-white text-[#535862] hover:border-[#d0d5dd]"
              )}
            >
              {label}
            </button>
      ...
      {tipo === "mensal" && (
        <div className="space-y-[12px]">
          ...
          <label className="flex items-center gap-[8px] cursor-pointer">
            ...
            />
            <span className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#414651]">No dia</span>
            <Input
              className="w-[56px] text-center bg-white"
              inputMode="numeric"
            ...
            />
            <span className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#414651]">do mês.</span>
          </label>
          ...
          <label className="flex items-center gap-[8px] cursor-pointer">
            <input
              ...
              className="size-[16px] accent-[#0b5ed7]"
            />
            <span className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#414651]">Na</span>
            <select
              value={form.recorrenciaMensalOrdem}
              onChange={(e) => update("recorrenciaMensalOrdem", e.target.value)}
              className="h-9 rounded-md border border-border bg-white px-2 font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#414651] outline-none cursor-pointer"
            >
              {ORDEM_OPTIONS.map((o) => <option key={o} value={o}>{o}</option>)}
            </select>
            <select
          ...
          {form.recorrenciaDatasPersonalizadas.length > 0 && (
            <div className="flex flex-wrap gap-[6px]">
              {form.recorrenciaDatasPersonalizadas.map((d) => (
                <span key={d} className="inline-flex items-center gap-[6px] rounded-full bg-[#e8f0fe] px-[10px] py-[4px] font-['Helvetica_Neue:Regular',sans-serif] text-[12px] text-[#0b5ed7]">
                  {d}
                  <button type="button" onClick={() => removeCustomDate(d)} className="cursor-pointer hover:text-[#084fb7] transition-colors">
                    <svg className="size-[12px]" viewBox="0 0 12 12" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><path d="M3 3l6 6M9 3l-6 6"/></svg>
                  </button>
                </span>
              ))}
...
function SuccessToast({ message, onClose }: { message: string; onClose: () => void }) {
  ...
  return createPortal(
    <div className={`fixed top-[24px] right-[24px] z-[200] w-[384px] flex overflow-clip rounded-[8px] border border-[#e4e4e7] bg-white shadow-[0px_4px_6px_-4px_rgba(0,0,0,0.1),0px_10px_15px_-3px_rgba(0,0,0,0.1)] transition-all duration-200 ${visible ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-[8px]"}`}>
      <div className="flex items-center justify-center shrink-0 w-[60px] bg-[#ecfdf3]">
      ...
      <div className="flex items-center justify-between flex-1 px-[16px] py-[16px]">
        <p className="font-['Helvetica_Neue:Medium',sans-serif] leading-[normal] text-[14px] text-[#252b37]">{message}</p>
        <button onClick={() => { setVisible(false); setTimeout(onClose, 200); }} className="cursor-pointer flex items-center justify-center size-[24px] rounded-[4px] hover:bg-[#f5f5f5] transition-colors shrink-0 ml-[12px]">
          <svg className="size-[14px]" fill="none" viewBox="0 0 14 14"><path d="M3.5 3.5l7 7M10.5 3.5l-7 7" stroke="#717680" strokeWidth="1.3" strokeLinecap="round"/></svg>
        </button>
      </div>
    </div>,
    document.body
...
function SaidaDrawer({
  ...
  const handleClose = () => { if (isClosing) return; setIsClosing(true); setTimeout(() => onClose(), 200); };
  ...
  const [drawerRemoveConfirm, setDrawerRemoveConfirm] = useState<{ guide?: string; all?: boolean } | null>(null);
  const [drawerToast, setDrawerToast] = useState<string | null>(null);

  const openDrawerMenu = useCallback((i: number, btnEl: HTMLButtonElement) => {
    if (drawerMemberMenu === i) { setDrawerMemberMenu(null); setDrawerMenuPos(null); return; }
  ...
  const filteredGuides = availableGuides.filter((g) => g.name.toLowerCase().includes(drawerTeamSearch.toLowerCase()));
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      if (drawerTeamRef.current && !drawerTeamRef.current.contains(e.target as Node)) setDrawerTeamOpen(false);
    };
    document.addEventListener("mousedown", handleClick);
    return () => document.removeEventListener("mousedown", handleClick);
  }, [drawerTeamOpen]);
  ...
  useEffect(() => {
    ...
    const handleClick = (e: MouseEvent) => {
      if (drawerMemberMenuRef.current && !drawerMemberMenuRef.current.contains(e.target as Node)) { setDrawerMemberMenu(null); setDrawerMenuPos(null); }
    };
  ...
  return (
    <div className="fixed inset-0 z-[60] flex justify-end" onKeyDown={(e) => e.key === "Escape" && handleClose()}>
      <div className={`absolute inset-0 bg-black/40 transition-opacity duration-200 ${isClosing ? "opacity-0" : "opacity-100"}`} onClick={handleClose} />
      <div className={`bg-white border border-[#e9eaeb] border-solid flex flex-col max-h-full relative rounded-l-[16px] shadow-[-8px_0px_24px_0px_rgba(0,0,0,0.1)] w-[480px] z-10 overflow-hidden ${isClosing ? "animate-out slide-out-to-right duration-200 fill-mode-forwards" : "animate-in slide-in-from-right duration-200"}`}>

        {/* ── Header ── */}
        <div className="shrink-0">
          <div className="flex items-center justify-between px-6 pt-5 pb-[16px]">
            <p className="font-['Helvetica_Neue:Medium',sans-serif] text-[16px] text-[#181d27]">Configurar saída {index}</p>
            <button onClick={handleClose} className="cursor-pointer flex items-center justify-center rounded-[6px] size-[32px] hover:bg-[#f5f5f5] transition-colors shrink-0">
        ...
        {/* ── Content ── */}
        <div className="flex-1 overflow-y-auto px-6 pb-5 pt-0 space-y-6 [&::-webkit-scrollbar]:w-[6px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-black/[0.08] [&::-webkit-scrollbar-thumb]:rounded-full hover:[&::-webkit-scrollbar-thumb]:bg-black/15 [&::-webkit-scrollbar-button]:hidden">
        {/* Horários */}
        <div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-5">
            <FieldRow label="Mínima">
              <Input
                ...
                onFocus={(e) => { if (localCapMin === 0) e.target.select(); }}
              />
            </FieldRow>
            <FieldRow label="Máxima">
              <Input
                className={cn(fieldSurfaceClass, localCapMax > 0 && localCapMin > 0 && localCapMax < localCapMin && "border-[#d92d20] focus-visible:border-[#d92d20] focus-visible:ring-[#d92d20]/20")}
                inputMode="numeric"
                ...
                onFocus={(e) => { if (localCapMax === 0) e.target.select(); }}
              />
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-end">
            {localEquipe.length > 0 && (
              <button type="button" onClick={() => setDrawerRemoveConfirm({ all: true })} className="font-['Helvetica_Neue:Regular',sans-serif] text-[12px] text-[#d92d20] hover:underline cursor-pointer">
                Remover todos
              </button>
            )}
          </div>
          ...
          <div className="relative" ref={drawerTeamRef}>
            <div className="flex items-center gap-[8px] w-full h-[40px] rounded-[8px] px-[12px] transition-colors border border-[#e9eaeb] hover:border-[#d0d5dd]">
              ...
              <input
                type="text"
                className="flex-1 font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#252b37] bg-transparent outline-none placeholder:text-muted-foreground"
                value={drawerTeamSearch}
                onChange={(e) => { setDrawerTeamSearch(e.target.value); if (!drawerTeamOpen) setDrawerTeamOpen(true); }}
                onFocus={() => setDrawerTeamOpen(true)}
                placeholder="Buscar ou adicionar membro..."
              />
              <button onClick={() => setDrawerTeamOpen(!drawerTeamOpen)} className="cursor-pointer shrink-0" type="button">
                <svg className={`size-[14px] text-[#a4a7ae] transition-transform ${drawerTeamOpen ? "rotate-180" : ""}`} fill="none" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
              </button>
            </div>
            {drawerTeamOpen && (
              <div className="absolute top-full left-0 right-0 mt-[4px] bg-white border border-[#e9eaeb] rounded-[8px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.12)] z-50 overflow-hidden">
                  ...
                  {filteredGuides.length > 0 ? filteredGuides.map((g) => {
                    ...
                    return (
                      <button
                        ...
                        className="flex w-full items-center gap-[10px] px-[12px] py-[8px] hover:bg-[#f8fafc] transition-colors cursor-pointer"
                      >
                        <div className="flex size-[28px] shrink-0 items-center justify-center rounded-full bg-[#e8f0fe] text-[11px] font-medium text-[#0b5ed7]">{gi}</div>
                        <div className="flex flex-col items-start min-w-0">
                          <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#252b37] truncate w-full text-left">{g.name}</p>
                          <p className={`text-[11px] ${g.available ? "text-[#17b26a]" : "text-[#f79009]"}`}>{g.available ? "Disponível" : "Em atividade"}</p>
                        </div>
                      </button>
                    );
                  }) : (
                    <p className="px-[12px] py-[8px] font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#717680]">Nenhum resultado encontrado</p>
                  )}
                </div>
              </div>
            )}
              ...
              {localEquipe.map((g, i) => {
                ...
                return (
                  <div key={g} className="flex items-center gap-[12px] px-[12px] py-[10px] rounded-[10px] border border-[#f5f5f5] bg-[#fafafa] hover:bg-[#f0f1f3] transition-colors">
                    ...
                    <div className="shrink-0">
                      <button type="button" onMouseDown={(e) => { e.stopPropagation(); e.preventDefault(); openDrawerMenu(i, e.currentTarget as HTMLButtonElement); }} className="cursor-pointer flex items-center justify-center size-[24px] rounded-[6px] border border-[#e9eaeb] bg-white hover:bg-[#f8fafc] transition-colors">
                        <svg className="size-[12px]" fill="none" viewBox="0 0 16 16"><circle cx="8" cy="3.5" r="1.2" fill="#717680"/><circle cx="8" cy="8" r="1.2" fill="#717680"/><circle cx="8" cy="12.5" r="1.2" fill="#717680"/></svg>
                      </button>
                    </div>
                  </div>
        ...
        <div className="shrink-0 border-t border-[#e9eaeb] px-6 py-4 flex items-center justify-end gap-[12px]">
          <button onClick={handleClose} className="cursor-pointer font-['Helvetica_Neue:Medium',sans-serif] text-[13px] text-[#535862] px-[16px] py-[8px] rounded-[8px] border border-[#e9eaeb] bg-white hover:bg-[#f8fafc] transition-colors">
            Cancelar
          </button>
          <button onClick={handleSave} className="cursor-pointer font-['Helvetica_Neue:Medium',sans-serif] text-[13px] text-white px-[16px] py-[8px] rounded-[8px] bg-[#0b5ed7] hover:bg-[#084fb7] transition-colors">
            Salvar
          </button>
        </div>
      </div>
      ...
      {drawerMemberMenu !== null && drawerMenuPos && (() => {
        const g = localEquipe[drawerMemberMenu];
        if (!g) return null;
        const hasIns = drawerInsurance[g] ?? false;
        return createPortal(
          <div ref={drawerMemberMenuRef} className="fixed z-[70] w-[200px] bg-white border border-[#f5f5f5] rounded-[8px] shadow-[0px_4px_16px_0px_rgba(0,0,0,0.12)] py-[4px]" style={{ top: drawerMenuPos.top, right: drawerMenuPos.right }}>
            <button type="button" onClick={() => { setDrawerInsurance((prev) => ({ ...prev, [g]: !prev[g] })); setDrawerMemberMenu(null); setDrawerMenuPos(null); }} className="cursor-pointer flex items-center gap-[8px] w-full px-[12px] py-[8px] hover:bg-[#f8fafc] transition-colors">
              {hasIns ? (
                <svg className="shrink-0 size-[16px] text-[#414651]" fill="none" viewBox="0 0 20 20"><path d="M16.54 10.4165C16.54 10.4165 16.6668 7.86136 16.54 7.55495C16.4131 7.24853 16.1722 7.00756 15.6905 6.52564L11.7434 2.5768C11.3277 2.16088 11.1198 1.95292 10.8623 1.8297C10.8087 1.80407 10.7538 1.78132 10.6978 1.76155C10.4286 1.6665 10.1346 1.6665 9.5467 1.6665C6.84251 1.6665 5.49042 1.6665 4.5746 2.40522C4.38959 2.55446 4.22106 2.72306 4.07189 2.90815C3.3335 3.82436 3.3335 5.17705 3.3335 7.88241V11.6709C3.3335 14.8149 3.3335 16.3869 4.30981 17.3637C5.09571 18.1499 7.48039 17.8866 9.5467 17.9165M10.8335 2.08335V2.5002C10.8335 4.85825 10.8335 6.03727 11.5657 6.76982C12.298 7.50237 13.4765 7.50237 15.8335 7.50237H16.2502" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M17.5 18.3335L12.5 13.3335M17.5 13.3335L12.5 18.3335" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg>
              ) : (
                <svg className="shrink-0 size-[16px] text-[#414651]" fill="none" viewBox="0 0 20 20"><path d="M16.6668 9.99984V8.88055C16.6668 8.1993 16.6668 7.85867 16.54 7.55239C16.4131 7.2461 16.1722 7.00524 15.6905 6.52353L11.7434 2.57641C11.3277 2.16067 11.1198 1.9528 10.8623 1.82962C10.8087 1.80401 10.7538 1.78127 10.6978 1.76151C10.4286 1.6665 10.1346 1.6665 9.5467 1.6665C6.84251 1.6665 5.49042 1.6665 4.5746 2.4049C4.38959 2.55407 4.22106 2.7226 4.07189 2.90761C3.3335 3.82343 3.3335 5.17552 3.3335 7.87971V11.6665C3.3335 14.8092 3.3335 16.3805 4.30981 17.3569C5.28612 18.3332 6.85747 18.3332 10.0002 18.3332M10.8335 2.08317V2.49984C10.8335 4.85686 10.8335 6.03537 11.5657 6.7676C12.298 7.49984 13.4765 7.49984 15.8335 7.49984H16.2502" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M16.6668 14.6855V13.0429C16.6668 12.7845 16.4771 12.5701 16.231 12.5261C15.2393 12.3488 14.416 11.9544 14.0144 11.7356C13.8499 11.6461 13.6505 11.6461 13.486 11.7356C13.0843 11.9544 12.2611 12.3488 11.2693 12.5261C11.0232 12.5701 10.8335 12.7845 10.8335 13.0429V14.6855C10.8335 16.8283 12.9522 17.9971 13.5781 18.2956C13.6885 18.3483 13.8118 18.3483 13.9223 18.2956C14.5482 17.9971 16.6668 16.8283 16.6668 14.6855Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" /></svg>
              )}
              <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#414651]">{hasIns ? "Desfazer seguro" : "Contratar seguro"}</p>
            </button>
            <button type="button" onClick={() => { setDrawerMemberMenu(null); setDrawerMenuPos(null); }} className="cursor-pointer flex items-center gap-[8px] w-full px-[12px] py-[8px] hover:bg-[#f8fafc] transition-colors">
              <svg className="shrink-0 size-[16px] text-[#075e54]" fill="none" viewBox="0 0 24 24"><path d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 13.3789 2.27907 14.6926 2.78382 15.8877C3.06278 16.5481 3.20226 16.8784 3.21953 17.128C3.2368 17.3776 3.16334 17.6521 3.01642 18.2012L2 22L5.79877 20.9836C6.34788 20.8367 6.62244 20.7632 6.87202 20.7805C7.12161 20.7977 7.45185 20.9372 8.11235 21.2162C9.30745 21.7209 10.6211 22 12 22Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" /><path d="M8.58815 12.3773L9.45909 11.2956C9.82616 10.8397 10.2799 10.4153 10.3155 9.80826C10.3244 9.65494 10.2166 8.96657 10.0008 7.58986C9.91601 7.04881 9.41086 7 8.97332 7C8.40314 7 8.11805 7 7.83495 7.12931C7.47714 7.29275 7.10979 7.75231 7.02917 8.13733C6.96539 8.44196 7.01279 8.65187 7.10759 9.07169C7.51023 10.8548 8.45481 12.6158 9.91948 14.0805C11.3842 15.5452 13.1452 16.4898 14.9283 16.8924C15.3481 16.9872 15.558 17.0346 15.8627 16.9708C16.2477 16.8902 16.7072 16.5229 16.8707 16.165C17 15.8819 17 15.5969 17 15.0267C17 14.5891 16.9512 14.084 16.4101 13.9992C15.0334 13.7834 14.3451 13.6756 14.1917 13.6845C13.5847 13.7201 13.1603 14.1738 12.7044 14.5409L11.6227 15.4118" stroke="currentColor" strokeWidth="1.5" /></svg>
              <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#075e54]">Ligar via WhatsApp</p>
            </button>
            <div className="bg-[#f5f5f5] h-px mx-[8px] my-[4px]" />
            <button type="button" onClick={() => { setDrawerRemoveConfirm({ guide: g }); setDrawerMemberMenu(null); setDrawerMenuPos(null); }} className="cursor-pointer flex items-center gap-[8px] w-full px-[12px] py-[8px] hover:bg-[#fef3f2] transition-colors">
              <svg className="shrink-0 size-[16px] text-[#d92d20]" fill="none" viewBox="0 0 24 24"><path d="M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2M19 6l-1 14a2 2 0 01-2 2H8a2 2 0 01-2-2L5 6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
              <p className="font-['Helvetica_Neue:Regular',sans-serif] text-[13px] text-[#d92d20]">Remover da saída</p>
            </button>
          </div>,
          document.body
        );
