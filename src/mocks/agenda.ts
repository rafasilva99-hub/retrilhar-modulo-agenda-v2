...
export const mockActivities: Activity[] = [
  ...
  },
  {
    ...
    cancellationReason: 'Condições climáticas adversas — previsão de chuva forte e ventos acima de 60 km/h',
  },
  {
    id: 'act-004',
  ...
  { id: 'act-013', name: 'Canoagem Rio das Velhas', date: dayOffset(-20), startTime: '08:00', endTime: '14:00', capacity: 10, occupancy: 8, guideName: 'Lucas Ferreira', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Lucas Ferreira'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-014', name: 'Trilha da Lua Cheia', date: dayOffset(-22), startTime: '18:00', endTime: '22:00', capacity: 15, occupancy: 15, guideName: 'Ana Paula Reis', status: 'full', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Ana Paula Reis'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-015', name: 'Escalada Paredão do Sol', date: dayOffset(-25), startTime: '07:00', endTime: '12:00', capacity: 8, occupancy: 6, guideName: 'Thiago Rocha', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Thiago Rocha'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-016', name: 'Rapel Cachoeira do Tabuleiro', date: dayOffset(-28), startTime: '09:00', endTime: '15:00', capacity: 12, occupancy: 4, guideName: '', status: 'pending', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: [], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },
  { id: 'act-017', name: 'Bike Tour Serra da Moeda', date: dayOffset(-30), startTime: '06:30', endTime: '11:00', capacity: 20, occupancy: 18, guideName: 'Pedro Santos', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Pedro Santos'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-018', name: 'Travessia Serra do Cipó', date: dayOffset(-35), startTime: '05:30', endTime: '18:00', capacity: 10, occupancy: 10, guideName: 'Carlos Vidal', status: 'full', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Carlos Vidal'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-019', name: 'Caminhada Noturna Inhotim', date: dayOffset(-40), startTime: '19:00', endTime: '23:00', capacity: 25, occupancy: 12, guideName: 'Sônia Brandão', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Sônia Brandão'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-020', name: 'Rafting Rio Jequitinhonha', date: dayOffset(-45), startTime: '08:00', endTime: '16:00', capacity: 16, occupancy: 9, guideName: 'João Silva', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['João Silva'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-021', name: 'Trilha Pico da Bandeira', date: dayOffset(-50), startTime: '04:00', endTime: '14:00', capacity: 12, occupancy: 12, guideName: 'Maria Costa', status: 'full', requiresInsurance: true, lifecycleStatus: 'Realizada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Maria Costa'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-022', name: 'Mergulho Gruta da Lapinha', date: dayOffset(-55), startTime: '10:00', endTime: '15:00', capacity: 6, occupancy: 3, guideName: 'Pedro Henrique Lima', status: 'pending', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Pedro Henrique Lima'], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },

  // ── Extended activities — future months ────────────────────────────────────

  { id: 'act-023', name: 'Tirolesa Vale do Rio Doce', date: dayOffset(15), startTime: '09:00', endTime: '12:00', capacity: 20, occupancy: 7, guideName: 'Lucas Ferreira', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Lucas Ferreira'], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },
  { id: 'act-024', name: 'Trilha Cachoeira Grande', date: dayOffset(18), startTime: '07:00', endTime: '13:00', capacity: 15, occupancy: 11, guideName: 'Ana Paula Reis', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Ana Paula Reis'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-025', name: 'Arvorismo Parque das Mangabeiras', date: dayOffset(20), startTime: '14:00', endTime: '17:00', capacity: 10, occupancy: 3, guideName: '', status: 'pending', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: [], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },
  { id: 'act-026', name: 'Rapel Mirante do Mangabeiras', date: dayOffset(28), startTime: '08:00', endTime: '11:00', capacity: 8, occupancy: 8, guideName: 'Thiago Rocha', status: 'full', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Thiago Rocha'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-027', name: 'Canoagem Represa de Furnas', date: dayOffset(32), startTime: '06:30', endTime: '14:00', capacity: 12, occupancy: 5, guideName: 'Jorge Cavalcanti', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Jorge Cavalcanti'], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },
  { id: 'act-028', name: 'Trilha Pico do Caraça', date: dayOffset(35), startTime: '05:00', endTime: '15:00', capacity: 10, occupancy: 7, guideName: 'Carlos Vidal', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Carlos Vidal'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-029', name: 'Bike Trail Estrada Real', date: dayOffset(38), startTime: '07:00', endTime: '16:00', capacity: 18, occupancy: 14, guideName: 'Mônica Duarte', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Mônica Duarte'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-030', name: 'Escalada Pedra do Elefante', date: dayOffset(42), startTime: '08:00', endTime: '13:00', capacity: 6, occupancy: 6, guideName: 'Pedro Santos', status: 'full', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Pedro Santos'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-031', name: 'Travessia Parque Estadual', date: dayOffset(45), startTime: '06:00', endTime: '18:00', capacity: 14, occupancy: 2, guideName: 'Roberta Nogueira', status: 'pending', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Roberta Nogueira'], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },
  { id: 'act-032', name: 'Rapel Cachoeira do Meio', date: dayOffset(50), startTime: '09:30', endTime: '14:00', capacity: 10, occupancy: 9, guideName: 'João Silva', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['João Silva'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },
  { id: 'act-033', name: 'Caminhada Serra do Gandarela', date: dayOffset(55), startTime: '07:00', endTime: '12:00', capacity: 20, occupancy: 16, guideName: 'Sônia Brandão', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Sônia Brandão'], allParticipantsInsured: true, participantsNeedingMedicalAttention: 0 },

  // ── Fixed date: May 14, 2026 — extra activities for usability test ────────
  { id: 'act-034', name: 'Canoagem Represa da Pampulha', date: '2026-05-14', startTime: '10:00', endTime: '13:00', capacity: 12, occupancy: 7, guideName: 'Lucas Ferreira', status: 'confirmed', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Lucas Ferreira'], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },
  { id: 'act-035', name: 'Trilha Mirante do Cruzeiro', date: '2026-05-14', startTime: '14:00', endTime: '17:00', capacity: 15, occupancy: 10, guideName: 'Ana Paula Reis', status: 'pending', requiresInsurance: true, lifecycleStatus: 'NaoIniciada', activityType: 'comum', timezone: 'BRT', assignedGuides: ['Ana Paula Reis'], allParticipantsInsured: false, participantsNeedingMedicalAttention: 0 },
];
