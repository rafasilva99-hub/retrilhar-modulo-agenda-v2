  ...
  sections: [
    ...
    },
    {
      ...
      screens: [
        ...
        {
          slug: "atualizacoes/participantes/checkin-bulk",
          step: 4,
          title: "Modal check-in (bulk)",
        },
    ...
    },
    {
      ...
      screens: [
        {
          slug: "atualizacoes/participantes/qr-camera-blocked",
          step: 1,
          title: "QR · câmera bloqueada",
        },
        { slug: "atualizacoes/participantes/qr-scanning", step: 2, title: "QR · escaneando" },
        {
          slug: "atualizacoes/participantes/qr-valid-reservation",
          step: 3,
          title: "QR · reserva válida",
        },
        {
          slug: "atualizacoes/participantes/qr-checkin-success",
          step: 4,
          title: "QR · check-in OK",
        },
        {
          slug: "atualizacoes/participantes/qr-reservation-cancelled",
          step: 5,
          title: "QR · reserva cancelada",
        },
        {
          slug: "atualizacoes/participantes/qr-not-recognized",
          step: 6,
    ...
    },
    {
      ...
      x: 0,
      y: 7220,
      screens: [{ slug: "novaAtividade", step: 1, title: "Formulário completo" }],
    },
  ],
};
