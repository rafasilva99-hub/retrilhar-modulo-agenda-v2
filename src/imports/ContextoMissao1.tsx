...
function Frame() {
  return (
    <div className="content-stretch flex flex-col font-['Sora:Regular',sans-serif] font-normal gap-[16px] items-start leading-[1.5] relative shrink-0 text-[16px] tracking-[-0.32px] w-full">
      <p className="relative shrink-0 w-full">Imagine que você está iniciando o seu dia de trabalho na Retrilhar. Como gestor da operação, precisa se organizar para saber o que vai acontecer hoje. Quais saídas estão programadas, quais equipes estão escaladas e o que pode exigir atenção antes do início das atividades.</p>
      <p className="relative shrink-0 w-full">Seus principal objetivo é:</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 text-white w-[490px]">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[1.4] relative shrink-0 text-[36px] tracking-[-0.72px] w-[456px]">Contextualizando - Missão Nº 1</p>
      <Frame />
    </div>
  );
}
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Sora:Regular',sans-serif] font-normal gap-[6px] items-start justify-center leading-[1.5] min-w-px relative">
      <p className="relative shrink-0 text-[16px] text-white tracking-[-0.32px] w-full">Entender o que está programado para hoje.</p>
      <p className="relative shrink-0 text-[#fafafa] text-[14px] tracking-[-0.28px] w-full">Veja quais saídas acontecem, em que horários e com quais equipes.</p>
    </div>
  );
}
...
function Frame7() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col font-['Sora:Regular',sans-serif] font-normal gap-[6px] items-start justify-center leading-[1.5] min-w-px relative">
      <p className="relative shrink-0 text-[16px] text-white tracking-[-0.32px] w-full">Se aprofunde em uma das atividades que chamar sua atenção.</p>
      <p className="relative shrink-0 text-[#fafafa] text-[14px] tracking-[-0.28px] w-full">Escolha uma das saídas de hoje e explore mais detalhes sobre ela.</p>
    </div>
  );
}
...
function TextPadding() {
  return (
    <div className="content-stretch flex items-center justify-center px-[2px] relative shrink-0" data-name="Text padding">
      <p className="font-['Sora:SemiBold',sans-serif] font-semibold leading-[28px] relative shrink-0 text-[18px] text-white whitespace-nowrap">Iniciar Teste</p>
    </div>
  );
}
...
function Frame8() {
  return (
    <div className="content-stretch flex flex-col gap-[20px] items-center relative shrink-0 w-[466px]">
      <p className="font-['Sora:Regular',sans-serif] font-normal leading-[1.5] relative shrink-0 text-[#fafafa] text-[14px] text-center tracking-[-0.28px] w-full">Quando estiver pronto(a), podemos começar.</p>
...
export default function ContextoMissao() {
  return (
    <div className="relative size-full" data-name="Contexto - Missão 1">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <img alt="" className="absolute h-[90.23%] left-[36.89%] max-w-none top-[9.75%] w-[63.12%]" src={imgContextoMissao1} />
        </div>
      </div>
      <Frame6 />
    </div>
