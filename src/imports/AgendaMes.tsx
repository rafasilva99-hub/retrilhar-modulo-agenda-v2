// @ts-nocheck
import svgPaths from "./svg-o16cukki7o";
...
function Container2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px relative w-full" data-name="Container">
      <Container3 />
      <Container4 />
    </div>
  );
...
function Container1() {
  return (
    <div className="bg-white flex-[1_0_0] min-w-px relative rounded-[24px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#e2e8f0] border-solid inset-0 pointer-events-none rounded-[24px] shadow-[0px_1px_3px_0px_rgba(10,13,18,0.08),0px_1px_2px_0px_rgba(10,13,18,0.06)]" />
...
function Container() {
  return (
    <div className="absolute content-stretch flex gap-[16px] items-start left-[248px] top-[192px] w-[1168px]" data-name="Container">
      <Container1 />
      <Container8 />
      <Container15 />
      <Container22 />
...
function Button1() {
  return (
    <div className="bg-white h-full relative rounded-[10px] shadow-[0px_0px_0px_0px_rgba(0,0,0,0.05),0px_1px_3px_0px_rgba(0,0,0,0.1),0px_1px_2px_0px_rgba(0,0,0,0.1)] shrink-0" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#084fb7] text-[12px] text-center w-[24px]">Mês</p>
        </div>
      </div>
    </div>
  );
...
function Button2() {
  return (
    <div className="h-full relative rounded-[10px] shrink-0" data-name="Button">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#62748e] text-[12px] text-center whitespace-nowrap">Semana</p>
        </div>
      </div>
    </div>
  );
...
function Frame() {
  return (
    <div className="h-full relative rounded-[10px] shrink-0">
      <div className="flex flex-col items-center justify-center size-full">
        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center px-[12px] py-[8px] relative size-full">
          <p className="font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#62748e] text-[12px] text-center w-[24px]">Dia</p>
        </div>
      </div>
    </div>
  );
...
function Container35() {
  return <div className="bg-[#d5d7da] rounded-[9999px] shrink-0 size-[5.998px]" data-name="Container" />;
}
...
function Elements10() {
  return (
    <div className="absolute inset-[8.33%]" data-name="elements">
      <div className="absolute inset-[-4.29%_-4.29%_-4.28%_-4.29%]">
...
function Container37() {
  return <div className="bg-[#2b7fff] rounded-[18641400px] shrink-0 size-[5.998px]" data-name="Container" />;
}
...
function CalendarCellMonthView6() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView7() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView8() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView9() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function Column1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Column">
      ...
      <CalendarCellMonthView6 />
      <CalendarCellMonthView7 />
      <CalendarCellMonthView8 />
      <CalendarCellMonthView9 />
    </div>
  );
}
...
function Events() {
  return <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] h-[86px] items-start min-w-px" data-name="Events" />;
}
...
function CalendarCellMonthView11() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex items-start p-[8px] relative size-full">
...
function CalendarCellMonthView12() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView13() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-end size-full">
...
function CalendarCellMonthView14() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function Column2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Column">
      ...
      <CalendarCellMonthView11 />
      <CalendarCellMonthView12 />
      <CalendarCellMonthView13 />
      <CalendarCellMonthView14 />
    </div>
  );
}
...
function Container47() {
  return <div className="bg-[#fb2c36] rounded-[18641400px] shrink-0 size-[5.998px]" data-name="Container" />;
}
...
function CalendarCellMonthView15() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView16() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView17() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView18() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView19() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function Column3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Column">
      ...
      <CalendarCellMonthView15 />
      <CalendarCellMonthView16 />
      <CalendarCellMonthView17 />
      <CalendarCellMonthView18 />
      <CalendarCellMonthView19 />
    </div>
  );
}
...
function CalendarCellMonthView20() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function Container60() {
  return <div className="bg-[#ff992b] rounded-[9999px] shrink-0 size-[5.998px]" data-name="Container" />;
}
...
function CalendarCellMonthView21() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView22() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex items-start p-[8px] relative size-full">
...
function CalendarCellMonthView23() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex items-start p-[8px] relative size-full">
...
function CalendarCellMonthView24() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function Column4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Column">
      ...
      <CalendarCellMonthView20 />
      <CalendarCellMonthView21 />
      <CalendarCellMonthView22 />
      <CalendarCellMonthView23 />
      <CalendarCellMonthView24 />
    </div>
  );
}
...
function CalendarCellMonthView25() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col items-end size-full">
...
function CalendarCellMonthView26() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView27() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function CalendarCellMonthView28() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="_Calendar cell/Month view">
      <div aria-hidden="true" className="absolute border-[#e9eaeb] border-b border-r border-solid inset-0 pointer-events-none" />
      <div className="content-stretch flex gap-[4px] items-start p-[8px] relative size-full">
...
function Column5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Column">
      ...
      <CalendarCellMonthView25 />
      <CalendarCellMonthView26 />
      <CalendarCellMonthView27 />
      <CalendarCellMonthView28 />
...
function Container33() {
  return (
    <div className="bg-white h-[611px] relative shrink-0 w-full" data-name="Container">
      <div className="overflow-clip rounded-[inherit] size-full">
...
function Container29() {
  return (
    <div className="absolute bg-white left-[248px] rounded-[24px] top-[363px] w-[1168px]" data-name="Container">
...
function SearchBar() {
  return (
    <div className="bg-white content-stretch flex gap-[8px] items-center px-[17px] py-[18px] relative rounded-[16px] shrink-0 w-[866.566px]" data-name="Search bar">
      <div aria-hidden="true" className="absolute border border-[#f5f5f5] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]" />
...
function TopBar1() {
  return (
    <div className="bg-white content-stretch flex gap-[10px] items-center px-[20px] py-[8px] relative rounded-[16px] shrink-0" data-name="TopBar">
      <div aria-hidden="true" className="absolute border border-[#f5f5f5] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]" />
      <TopBar2 />
      <TopBar3 />
    </div>
...
function TopBar() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-center pl-[248px] pr-[24px] py-[24px] right-0 top-0 w-[1440px]" data-name="TopBar">
      <SearchBar />
      <TopBar1 />
      <button className="bg-white content-stretch cursor-pointer flex items-center p-[10px] relative rounded-[16px] shrink-0" data-name="Notification">
        <div aria-hidden="true" className="absolute border border-[#f5f5f5] border-solid inset-0 pointer-events-none rounded-[16px] shadow-[0px_1px_2px_0px_rgba(10,13,18,0.05)]" />
...
function Elements21() {
  return (
    <div className="relative size-full" data-name="elements">
      <div className="absolute inset-[-4.5%_-5%_-4.51%_-5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.5 18.1667">
          <g id="elements">
...
function Elements22() {
  return (
    <div className="relative size-full" data-name="elements">
      <div className="absolute inset-[-4.74%_-4.74%_-4.73%_-4.74%]">
...
function Elements23() {
  return (
    <div className="relative size-full" data-name="elements">
      <div className="absolute inset-[-5.02%_-5.01%_-5%_-5%]">
...
function Frame23() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      ...
      <div className="content-stretch flex h-[140px] items-start relative shrink-0" data-name="Vendas dropdown">
...
function Frame25() {
  return (
    <div className="absolute content-stretch flex gap-[24px] items-end left-[248px] top-[112px] w-[1168px]">
      <DashboardContent />
      <Frame24 />
    </div>
  );
...
export default function AgendaMes() {
  return (
    <div className="bg-[#f8fafc] relative size-full" data-name="AGENDA - MÊS">
      <Container />
      <Container29 />
      <TopBar />
