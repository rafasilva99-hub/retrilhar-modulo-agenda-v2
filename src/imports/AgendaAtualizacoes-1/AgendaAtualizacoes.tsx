// @ts-nocheck
import svgPaths from "./svg-i9p5ikbpf9";
    ...
    <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="elements">
      <div className="absolute inset-[-25%_-12.5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.5001 4.50005">
          <g id="elements">
            <path d={svgPaths.p30242a80} id="Vector" stroke="var(--stroke-0, #414651)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
          </g>
        </svg>
      </div>
    </div>
...
function Frame37() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-center justify-end min-w-px relative">
      ...
      <div className="bg-[#edf0ff] content-stretch flex gap-[8px] items-center justify-center px-[16px] py-[10px] relative rounded-[6px] shrink-0" data-name="button">
...
function Avatar3() {
  return (
    <div className="relative shrink-0 size-[32px]" data-name="avatar">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <circle cx="16" cy="16" fill="var(--fill-0, #EEF4FF)" id="Ellipse 1" r="15.5" stroke="var(--stroke-0, #E0EAFF)" />
      </svg>
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[19.2px] left-1/2 not-italic overflow-hidden text-[#252b37] text-[12.8px] text-center text-ellipsis top-[calc(50%-9.6px)] w-[22.4px] whitespace-nowrap">🚐</p>
    </div>
  );
...
function Frame7() {
  return (
    <div className="bg-[#eef4ff] flex-[1_0_0] min-w-px relative rounded-[10px]">
      <div aria-hidden="true" className="absolute border border-[#e0eaff] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col gap-[4px] items-start justify-center not-italic px-[16px] py-[12px] relative size-full">
          <Frame16 />
...
function Frame24() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[20px] h-[843px] items-start left-[248px] top-[157px] w-[743px]">
      <div className="content-stretch flex flex-col gap-[12px] h-[147px] items-end justify-center relative shrink-0 w-[743px]" data-name="Text field area">
        <div className="bg-white flex-[1_0_0] min-h-[80px] relative rounded-[12px] w-full" data-name="Text field area">
          ...
          <div className="content-stretch flex gap-[12px] items-start min-h-[inherit] px-[16px] py-[12px] relative size-full">
            <div className="flex flex-[1_0_0] flex-col font-['Helvetica_Neue:Regular',sans-serif] justify-center leading-[0] min-w-px not-italic relative text-[#414651] text-[0px]">
              <p className="text-[14px]">
                <span className="font-['Helvetica_Neue:Regular',sans-serif] leading-[normal]">Lorem ipsum non magna mi volutpat eg</span>
                <span className="font-['Helvetica_Neue:Medium',sans-serif] leading-[normal]">|</span>
              </p>
            </div>
            <div className="content-stretch flex gap-[2px] items-center relative shrink-0" data-name="Toggle Group/Default">
              <div className="content-stretch flex h-[24px] items-center justify-center px-[7.2px] py-[4.8px] relative rounded-[3.6px] shrink-0" data-name="Toggle/Default">
                  ...
                  <div className="absolute bottom-[16.67%] left-1/4 right-[20.83%] top-[16.67%]" data-name="Vector">
                    <div className="absolute inset-[-4.69%_-5.77%]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 5.8 7">
                        <path d={svgPaths.p1ea22600} id="Vector" stroke="var(--stroke-0, #09090B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.6" />
                      </svg>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="absolute inset-[16.67%_20.83%]" data-name="Vector">
                    <div className="absolute inset-[-4.69%_-5.36%]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 6.2 7.00016">
                        <path d={svgPaths.p3d68a1a0} id="Vector" stroke="var(--stroke-0, #09090B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.6" />
                      </svg>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="absolute inset-[16.67%]" data-name="Vector">
                    <div className="absolute inset-[-4.69%]">
                      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 7">
                        <path d={svgPaths.p3bef9580} id="Vector" stroke="var(--stroke-0, #09090B)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.6" />
                      </svg>
                    </div>
                  </div>
                </div>
...
function Frame2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start justify-center min-w-px relative">
      <p className="font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#414651] text-[14px] whitespace-nowrap">Visão Geral</p>
    </div>
  );
}
...
function Frame1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[2px] items-start justify-center min-w-px relative">
      <p className="font-['Helvetica_Neue:Regular',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#0b5ed7] text-[14px] whitespace-nowrap">Atualizações</p>
    </div>
  );
}
...
function Frame20() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full">
      ...
      <div className="bg-[#edf0ff] h-[48px] relative rounded-[14px] shrink-0 w-full" data-name="Component 4">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[12px] items-center pl-[16px] pr-[12px] py-[14px] relative size-full">
...
export default function AgendaAtualizacoes() {
  return (
